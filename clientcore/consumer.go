...
func NewConsumerWebRTC(options *WebRTCOptions, wg *sync.WaitGroup) *WorkerFSM {
	return NewWorkerFSM(wg, []FSMstate{
		newFSMstate0(options),
		newFSMstate1(options),
		newFSMstate2(options),
		newFSMstate3(options),
		newFSMstate4(options),
		newFSMstate5(options),
	})
}

func newFSMstate0(options *WebRTCOptions) FSMstate {
	return FSMstate(func(ctx context.Context, com *ipcChan, input []interface{}) (int, []interface{}) {
		// State 0
		// (no input data)
...
func newFSMstate1(options *WebRTCOptions) FSMstate {
	return FSMstate(func(ctx context.Context, com *ipcChan, input []interface{}) (int, []interface{}) {
		// State 1
...
func newFSMstate2(options *WebRTCOptions) FSMstate {
	return FSMstate(func(ctx context.Context, com *ipcChan, input []interface{}) (int, []interface{}) {
		// State 2
		// input[0]: *webrtc.PeerConnection
...
func newFSMstate3(options *WebRTCOptions) FSMstate {
	return FSMstate(func(ctx context.Context, com *ipcChan, input []interface{}) (int, []interface{}) {
		// State 3
		// input[0]: *webrtc.PeerConnection
...
func newFSMstate4(options *WebRTCOptions) FSMstate {
	return FSMstate(func(ctx context.Context, com *ipcChan, input []interface{}) (int, []interface{}) {
		// State 4
		// input[0]: *webrtc.PeerConnection
		// input[1]: chan *webrtc.DataChannel
...
func newFSMstate5(options *WebRTCOptions) FSMstate {
	return FSMstate(func(ctx context.Context, com *ipcChan, input []interface{}) (int, []interface{}) {
		// State 5
		// input[0]: *webrtc.PeerConnection

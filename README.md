...
```html
<broflake data-layout="banner" data-theme="dark" data-features='{"globe": true, "toast": true, "mobile-bg": false, "desktop-bg": true}' style='width: calc(100% - 20px); padding: 10px;'></broflake>

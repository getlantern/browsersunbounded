...
2. Configure your .env file: `cp .env.example .env` 
   ...
   3. Set `REACT_APP_GEO_LOOKUP` to your intended geo lookup service. Most likely `https://go-geoserve.herokuapp.com/lookup` or `http://localhost:<PORT>/lookup` if testing geo lookups locally
